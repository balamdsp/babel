...
private:
    ...
    std::unique_ptr<OpenGLShaderProgram> createProgram (const char* vs, const char* fs)
    {
        ...
        Logger::writeToLog ("Babel CRT shader link failed: " + program->getLastError());
        return nullptr;
    }
...
void main()
{
    ...
    static constexpr float kFontColorR   = 0.18f;
    static constexpr float kFontColorG   = 0.66f;
    static constexpr float kFontColorB   = 1.00f;
    static constexpr float kBackgroundColorR = 0.016f;
    static constexpr float kBackgroundColorG = 0.039f;
    static constexpr float kBackgroundColorB = 0.070f;
