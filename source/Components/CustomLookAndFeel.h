...
namespace BabelColors
{
    static const juce::Colour background{0xff040a12};
    static const juce::Colour body{0xff060d16};
    static const juce::Colour card{0xff0a1420};
    static const juce::Colour cardDark{0xff070f18};
    static const juce::Colour headerBg{0xff040a12};

    static const juce::Colour accent{0xff2ea8ff};
    static const juce::Colour highlight{0xff9adcff};
    static const juce::Colour accentDim{0xff0a2a44};
    static const juce::Colour accentSoft{0xff2a6a9a};

    static const juce::Colour textPrimary{0xff2ea8ff};
    static const juce::Colour textMid{0xff5f9ecf};
    static const juce::Colour textBrand{0xff9adcff};

    static const juce::Colour buttonOff{0xff0a1420};
    static const juce::Colour buttonOn{0xff10283c};
    static const juce::Colour buttonBorder{0xff1e4a6e};

    static const juce::Colour menuBg{0xff070f18};
    static const juce::Colour menuText{0xff2ea8ff};
    static const juce::Colour menuTextBright{0xff9adcff};
    static const juce::Colour menuTextDim{0xff2a6a9a};
    static const juce::Colour menuHover{0xff0c1c30};
    static const juce::Colour menuBorder{0xff1a3a56};
    static const juce::Colour menuInnerBorder{0xff0a1420};
}
...
public:
    ...
    class BabelSliderTextLabel final : public juce::Label
    {
    public:
        BabelSliderTextLabel() : juce::Label({}, {}) {}
        ...
        {
            te->setColour(juce::TextEditor::outlineColourId, BabelColors::accentDim.withAlpha(0.35f));
            te->setColour(juce::TextEditor::backgroundColourId, BabelColors::background.withAlpha(0.6f));
            te->setJustification(juce::Justification::centred);
        }

        void mouseWheelMove(const juce::MouseEvent&, const juce::MouseWheelDetails&) override {}

        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(BabelSliderTextLabel)
    };
    ...
    juce::Label* createSliderTextBox(juce::Slider& slider) override
    {
        ...
        auto* l = new BabelSliderTextLabel();
    ...
    {
        if (dynamic_cast<BabelSliderTextLabel*> (&label) != nullptr)
            return getFont (22.0f);
        if (label.getFont().getTypefaceName() == juce::Font::getDefaultSansSerifFontName())
            return getFont (17.0f);
        return label.getFont();
    }

    class BabelDocumentWindowButton final : public juce::Button
    {
    public:
        BabelDocumentWindowButton (const juce::String& name, juce::Colour c,
        ...
        void paintButton (juce::Graphics& g, bool shouldDrawButtonAsHighlighted, bool shouldDrawButtonAsDown) override
        {
            ...
            {
                g.fillAll();
                g.setColour (BabelColors::background);
            }
    ...
    private:
        ...
        JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BabelDocumentWindowButton)
    };
    ...
    juce::Button* createDocumentWindowButton (int buttonType) override
    {
        ...
        if (buttonType == juce::DocumentWindow::closeButton)
        {
            ...
            return new BabelDocumentWindowButton ("close", BabelColors::textBrand, shape, shape);
        }

        if (buttonType == juce::DocumentWindow::minimiseButton)
        {
            shape.addLineSegment ({ 0.0f, 0.5f, 1.0f, 0.5f }, crossThickness);
            return new BabelDocumentWindowButton ("minimise", BabelColors::textBrand, shape, shape);
        }
        ...
        if (buttonType == juce::DocumentWindow::maximiseButton)
        {
            ...
            shape.addLineSegment ({ 0.0f, 0.5f, 1.0f, 0.5f }, crossThickness);
            return new BabelDocumentWindowButton ("maximise", BabelColors::textBrand, shape, shape);
        }
                                     ...
                                     const juce::Image* icon, bool drawTitleTextOnLeft) override
    {
        ...
        g.setColour (BabelColors::textBrand);
