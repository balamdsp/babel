...
/**
    ...
    @tags{Audio}
*/
class BabelPluginHolder    : private AudioIODeviceCallback,
                                  private Timer,
...
public:
    ...
    */
    BabelPluginHolder (PropertySet* settingsToUse,
    ...
    {
        // Only one BabelPluginHolder may be created at a time
    ...
    static BabelPluginHolder* getInstance()
    {
...
private:
    inline static BabelPluginHolder* currentInstance = nullptr;
    ...
    {
    public:
        SettingsComponent (BabelPluginHolder& pluginHolder,
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BabelPluginHolder)
};
...
/**
    ...
    @tags{Audio}
*/
class BabelFilterWindow    : public DocumentWindow
{
public:
    typedef BabelPluginHolder::PluginInOuts PluginInOuts;

    BabelFilterWindow (const String& title,
                            Colour backgroundColour,
                            std::unique_ptr<BabelPluginHolder> pluginHolderIn)
    ...
    */
    BabelFilterWindow (const String& title,
        ...
        : BabelFilterWindow (title,
                                  backgroundColour,
                                  std::make_unique<BabelPluginHolder> (settingsToUse,
    ...
    // menu via BabelPluginHolder::getInstance()->showAudioSettingsDialog().

    virtual BabelPluginHolder* getPluginHolder()    { return pluginHolder.get(); }
...
private:
    ...
    {
    public:
        MainContentComponent (BabelFilterWindow& filterWindow)
    ...
    */
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BabelFilterWindow)
};
